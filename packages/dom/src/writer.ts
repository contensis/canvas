...
type ComposedItemWriter<T extends ComposedItem, TNode> = (props: WriteComposedItemProps<T>, ...children: TNode[]) => TNode;
...
type DecoratorWriter<TNode> = (props: WriteDecoratorProps, ...children: TNode[]) => TNode;
...
type ComponentItemWriter<TNode> = (props: WriteComposedItemProps<ComponentComposedItem>, ...children: TNode[]) => TNode;
...
class DomWriter<TNode, TFragment> {
    ...
    _anchor(props: WriteComposedItemProps<AnchorComposedItem>, ...children: TNode[]) {
    ...
    _code(props: WriteComposedItemProps<CodeComposedItem>, ...children: TNode[]) {
        const { item, context } = props;
        const attributes = this.getAttributes(props, {
    ...
    _codeChildren(props: WriteComposedItemProps<CodeComposedItem>) {
        return this.toFragment([this.hText(props.item?.value?.code)]);
    }

    _component(props: WriteComposedItemProps<ComponentComposedItem>, ...children: TNode[]) {
        const { item, context } = props;
    ...
    _componentChildren(props: WriteComposedItemProps<ComponentComposedItem>) {
        return this.toFragment([this.hText(`Component: ${props.item?.properties?.component}`)]);
    }
    ...
    _fragment(props: WriteComposedItemProps<FragmentComposedItem>, ...children: TNode[]) {
        const { item, context } = props;
    ...
    _heading(props: WriteComposedItemProps<HeadingComposedItem>, ...children: TNode[]) {
        const { item, context } = props;
        const attributes = this.getAttributes(props);
    ...
    _inlineEntry(props: WriteComposedItemProps<InlineEntryComposedItem>, ...children: TNode[]) {
        const { item, context } = props;
    ...
    _inlineEntryChildren(props: WriteComposedItemProps<InlineEntryComposedItem>) {
        ...
        return this.toFragment([this.hText(entryTitle)]);
    }

    _link(props: WriteComposedItemProps<LinkComposedItem>, ...children: TNode[]) {
        const { item, context } = props;
    ...
    _list(props: WriteComposedItemProps<ListComposedItem>, ...children: TNode[]) {
        const { item, context } = props;
    ...
    _listItem(props: WriteComposedItemProps<ListItemComposedItem>, ...children: TNode[]) {
        const { item, context } = props;
        const attributes = this.getAttributes(props);
        return this.h(
            'li',
    ...
    _panel(props: WriteComposedItemProps<PanelComposedItem>, ...children: TNode[]) {
        const { item, context } = props;
        const attributes = this.getAttributes(props, {
    ...
    _paragraph(props: WriteComposedItemProps<ParagraphComposedItem>, ...children: TNode[]) {
        const { item, context } = props;
        const attributes = this.getAttributes(props, {
    ...
    _table(props: WriteComposedItemProps<TableComposedItem>, ...children: TNode[]) {
        const { item, context } = props;
        const attributes = this.getAttributes(props);
        return this.h(
            'table',
    ...
    _tableBody(props: WriteComposedItemProps<TableBodyComposedItem>, ...children: TNode[]) {
        const { item, context } = props;
        const attributes = this.getAttributes(props);
        return this.h(
            'tbody',
    ...
    _tableCaption(props: WriteComposedItemProps<TableCaptionComposedItem>, ...children: TNode[]) {
        const { item, context } = props;
        const attributes = this.getAttributes(props);
        return this.h(
            'caption',
    ...
    _tableCell(props: WriteComposedItemProps<TableCellComposedItem>, ...children: TNode[]) {
        const { item, context } = props;
        const attributes = this.getAttributes(props);
        return this.h(
            'td',
    ...
    _tableFooter(props: WriteComposedItemProps<TableFooterComposedItem>, ...children: TNode[]) {
        const { item, context } = props;
        const attributes = this.getAttributes(props);
        return this.h(
            'tfoot',
    ...
    _tableHeader(props: WriteComposedItemProps<TableHeaderComposedItem>, ...children: TNode[]) {
        const { item, context } = props;
        const attributes = this.getAttributes(props);
        return this.h(
            'thead',
    ...
    _tableHeaderCell(props: WriteComposedItemProps<TableHeaderCellComposedItem>, ...children: TNode[]) {
        const { item, context } = props;
        const attributes = this.getAttributes(props);
        return this.h(
            'th',
    ...
    _tableRow(props: WriteComposedItemProps<TableRowComposedItem>, ...children: TNode[]) {
        const { item, context } = props;
        const attributes = this.getAttributes(props);
        return this.h(
            'tr',
    ...
    code(props: WriteDecoratorProps, ...children: TNode[]) {
        const attributes = this.getAttributes(props);
    ...
    delete(props: WriteDecoratorProps, ...children: TNode[]) {
        const attributes = this.getAttributes(props);
        const { item, context, decorator, otherDecorators } = props;
        return this.h(
            'del',
    ...
    emphasis(props: WriteDecoratorProps, ...children: TNode[]) {
        const attributes = this.getAttributes(props);
        const { item, context, decorator, otherDecorators } = props;
        return this.h(
            'em',
    ...
    insert(props: WriteDecoratorProps, ...children: TNode[]) {
        const attributes = this.getAttributes(props);
        const { item, context, decorator, otherDecorators } = props;
        return this.h(
            'ins',
    ...
    keyboard(props: WriteDecoratorProps, ...children: TNode[]) {
        const attributes = this.getAttributes(props);
        const { item, context, decorator, otherDecorators } = props;
        return this.h(
            'kbd',
    ...
    mark(props: WriteDecoratorProps, ...children: TNode[]) {
        const attributes = this.getAttributes(props);
        const { item, context, decorator, otherDecorators } = props;
        return this.h(
            'mark',
    ...
    strong(props: WriteDecoratorProps, ...children: TNode[]) {
        const attributes = this.getAttributes(props);
        const { item, context, decorator, otherDecorators } = props;
        return this.h(
            'strong',
    ...
    strikethrough(props: WriteDecoratorProps, ...children: TNode[]) {
        const attributes = this.getAttributes(props);
        const { item, context, decorator, otherDecorators } = props;
        return this.h(
            's',
    ...
    subscript(props: WriteDecoratorProps, ...children: TNode[]) {
        const attributes = this.getAttributes(props);
        const { item, context, decorator, otherDecorators } = props;
        return this.h(
            'sub',
    ...
    superscript(props: WriteDecoratorProps, ...children: TNode[]) {
        const attributes = this.getAttributes(props);
        const { item, context, decorator, otherDecorators } = props;
        return this.h(
            'sup',
    ...
    underline(props: WriteDecoratorProps, ...children: TNode[]) {
        const attributes = this.getAttributes(props);
        const { item, context, decorator, otherDecorators } = props;
        return this.h(
            'u',
    ...
    variable(props: WriteDecoratorProps, ...children: TNode[]) {
        const attributes = this.getAttributes(props);
        const { item, context, decorator, otherDecorators } = props;
        return this.h(
            'var',
    ...
    private toFragment(children: TNode[]) {
    ...
    private writeText(props: WriteTextProps) {
        return this.toFragment([this.hText(props.text)]);
    }
    ...
    private withCaption(caption: string | undefined, ...children: TNode[]) {
        return this.h(
            'figure',
            {},
            ...children,
            this.h('figcaption', {}, this.hText(caption))
        );
    }
...
export function createDomWriterFactory<TNode, TFragment>(
    ...
    const writer = new DomWriter(h, hFragment, hText);
